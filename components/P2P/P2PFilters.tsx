    ...
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
      ...
      <div className="relative w-full sm:w-48">
        <div className="flex items-center bg-slate-800/50 rounded-md border border-slate-700">
          ...
          <Input
            ...
            className="flex-1 bg-transparent px-2 py-1.5 outline-none text-xs text-white placeholder-slate-500 border-none shadow-none"
          />
      ...
      <div className="flex gap-2 sm:gap-3">
        ...
        <Button 
          variant="outline" 
          size="sm" 
          className="flex items-center justify-center gap-1.5 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700 rounded-md px-3 py-1.5 text-xs text-slate-400 transition-colors flex-1 sm:flex-none"
        >
