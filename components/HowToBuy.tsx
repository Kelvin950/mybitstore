...
export default function HowToBuy(){
    return <div className="max-w-4xl mx-auto px-6 py-8 animate-slide-in" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { title: 'Create a account', icon: "/images/image2.png" },
            { title: 'Verify KYC and Add payment method', icon: "/images/image3.png" },
            { title: 'Funds account', icon: "/images/image2.png" }
          ].map((step, index) => (
            <div
              key={index}
            ...
            >
              <div className="w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center mb-4 mx-auto">
                <Image src={step.icon} alt='icons' width={500} height={300} />
              </div>
